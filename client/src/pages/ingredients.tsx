...
const UNITS = ["g", "kg", "ml", "l", "pcs", "cup", "tbsp", "tsp", "oz", "lb", "box", "bag", "bottle", "pack"];
            ...
            return (
              ...
              >
                ...
                <div className="flex items-center gap-1 shrink-0">
                  <button
                    onClick={() =>
                      adjustStockMutation.mutate({ id: ing.id, delta: -1 })
                    }
                    className="h-8 w-8 rounded-xl hover:bg-rose-500/10 hover:text-rose-500 flex items-center justify-center text-muted-foreground/60 transition-colors"
                    title="Deduct 1 unit"
                  >
                  ...
                  <button
                    ...
                    className="h-8 w-8 rounded-xl hover:bg-emerald-500/10 hover:text-emerald-600 flex items-center justify-center text-muted-foreground/60 transition-colors"
                    title="Add 1 unit"
                  >
                  ...
                  {pendingDeleteId === ing.id ? (
                    <>
                      ...
                      <button
                        ...
                        onClick={() => { if (deleteTimer) clearTimeout(deleteTimer); setPendingDeleteId(null); }}
                        title="Cancel"
                      >
        ...
        <DialogContent className="sm:max-w-[460px] max-w-[calc(100vw-24px)] rounded-3xl border-none shadow-2xl">
          ...
          <div className="space-y-4 pt-2">
            ...
            <div>
              ...
              <Textarea
                className="mt-1 resize-none rounded-xl bg-secondary border-none"
                rows={2}
            ...
            <Button
              className="w-full rounded-2xl h-12 font-bold mt-2"
