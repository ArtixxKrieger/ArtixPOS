      ...
      >
        {value ? (
          ...
          <span className="text-sm text-muted-foreground flex-1">
            {t("onboarding.countryPicker.selectPrompt")}
          </span>
        )}
      </button>
          ...
          >
            <div className="px-4 pt-4 pb-3 border-b border-border/30">
              <p className="text-sm font-bold text-foreground mb-2">
                {t("onboarding.countryPicker.title")}
              </p>
    ...
    <div className="h-screen overflow-y-auto overscroll-none flex flex-col bg-gradient-to-br from-violet-50 via-white to-blue-50 dark:from-[#0c0c18] dark:via-[#080810] dark:to-[#0a0c18]">
      ...
      <header className="relative z-10 w-full px-5 sm:px-8 py-4 sm:py-5 flex items-center justify-between flex-wrap gap-3">
        <div className="flex items-center gap-2.5">
          ...
          <span className="text-xs font-bold tracking-[0.15em] text-primary/80 uppercase">
            ArtixPOS
          </span>
        </div>
          ...
          <div className="w-full max-w-2xl animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="text-center mb-8 sm:mb-10">
              ...
              <p className="text-base sm:text-lg text-muted-foreground max-w-sm sm:max-w-md mx-auto leading-relaxed">
                Set up your store in minutes. Everything you need to run your business, all in one
                place.
              </p>
            </div>
        ...
        {step === "business_type" && (
          <div className="w-full max-w-xl animate-in fade-in slide-in-from-right-4 duration-400">
              ...
              {BUSINESS_TYPES.map((bt, i) => {
                ...
                return (
                  ...
                  >
                    <div
                      className={[
                        "w-12 h-12 rounded-2xl flex items-center justify-center shrink-0 sm:mb-4",
                        bt.iconBg,
                      ].join(" ")}
                    >
                    ...
                    <div>
                      <h3 className="text-sm sm:text-base font-bold text-foreground mb-0.5 sm:mb-1">
                        {bt.label}
                      </h3>
            ...
            <div className="mt-5 sm:mt-6 flex justify-end">
              ...
              >
                {t("onboarding.businessType.continueButton")}{" "}
        ...
        {step === "business_subtype" && businessType && (
          <div className="w-full max-w-xl animate-in fade-in slide-in-from-right-4 duration-400">
            <div className="text-center mb-6 sm:mb-8">
              ...
              <p className="text-sm sm:text-base text-muted-foreground">
                {t("onboarding.businessSubtype.subtitle")}
              </p>
            </div>
            ...
            <div className="mt-5 sm:mt-6 flex justify-end">
              <Button
                ...
                className="w-full sm:w-auto sm:px-8 h-11 sm:h-12 rounded-2xl font-bold"
              >
                {t("onboarding.businessSubtype.continueButton")}{" "}
                <ChevronRight className="w-4 h-4 ml-1" />
              </Button>
            </div>
          </div>
        ...
        {step === "store_info" && (
          <div className="w-full max-w-md animate-in fade-in slide-in-from-right-4 duration-400">
            <div className="text-center mb-6 sm:mb-8">
              ...
              <p className="text-sm sm:text-base text-muted-foreground">
                {t("onboarding.storeInfo.subtitle")}
              </p>
            </div>
            ...
            <div className="bg-white dark:bg-white/5 rounded-2xl sm:rounded-3xl border border-border/50 shadow-sm p-5 sm:p-6 space-y-4">
              <div>
                <Label className="text-xs font-semibold text-muted-foreground mb-2 block">
                  {t("onboarding.storeInfo.countryLabel")} *
                </Label>
                <CountryPicker value={storeCountry} onChange={handleCountryChange} />
                {storeCountry && (
                  <p className="text-[10px] text-muted-foreground mt-1 flex items-center gap-1">
                    <span className="font-medium text-foreground">{storeCountry.currency}</span>{" "}
                    {t("onboarding.countryPicker.currency")} ·
              ...
              <div>
                <Label className="text-xs font-semibold text-muted-foreground mb-2 block">
                  {t("onboarding.storeInfo.storeNameLabel")} *
                </Label>
                <Input
              ...
              <div>
                <Label className="text-xs font-semibold text-muted-foreground mb-2 block">
                  {t("onboarding.storeInfo.addressLabel")} *
                </Label>
                <Input
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <Label className="text-xs font-semibold text-muted-foreground mb-2 block">
                    {t("onboarding.storeInfo.phoneLabel")} *
                  </Label>
                  <Input
                    ...
                    placeholder={
                      storeCountry ? `${storeCountry.phonePrefix} 912 345 6789` : "+63 912 345 6789"
                    }
                    className="rounded-xl h-11"
                    type="tel"
                  />
                ...
                <div>
                  <Label className="text-xs font-semibold text-muted-foreground mb-2 block">
                    {t("onboarding.storeInfo.emailLabel")} *
                  </Label>
                  <Input
            ...
            <div className="mt-4 sm:mt-5 flex justify-end">
              ...
              >
                {isSubmitting
                  ? t("onboarding.storeInfo.saving")
                  : t("onboarding.storeInfo.reviewButton")}
              </Button>
            </div>
          </div>
        )}
        ...
        <AlertDialogContent className="rounded-2xl max-w-sm mx-4">
          <AlertDialogHeader>
            <AlertDialogTitle className="text-lg">
              {t("onboarding.confirmDialog.title")}
            </AlertDialogTitle>
              ...
              <div className="space-y-3 text-left">
                <div className="space-y-2 p-3 rounded-xl bg-muted/50 border border-border/40">
                  <div>
                    <p className="text-[10px] font-semibold text-muted-foreground uppercase tracking-wide">
                      {t("onboarding.confirmDialog.storeLabel")}
                    </p>
                  ...
                  {storeCountry && (
                    <div>
                      <p className="text-[10px] font-semibold text-muted-foreground uppercase tracking-wide">
                        {t("onboarding.confirmDialog.countryLabel")}
                      </p>
                      <p className="text-sm font-semibold text-foreground">
                        <img
                          src={`https://flagcdn.com/w40/${storeCountry.code.toLowerCase()}.png`}
                          srcSet={`https://flagcdn.com/w80/${storeCountry.code.toLowerCase()}.png 2x`}
                          alt={storeCountry.code}
                          className="w-5 h-3.5 object-cover rounded-[2px] inline-block shrink-0 shadow-sm align-[-1px]"
                        />{" "}
                        {storeCountry.name}
                        <span className="text-muted-foreground font-normal">
                          {" "}
                          · {storeCountry.currency}
                        </span>
                      </p>
                    </div>
                  )}
                  <div>
                    <p className="text-[10px] font-semibold text-muted-foreground uppercase tracking-wide">
                      {t("onboarding.confirmDialog.businessTypeLabel")}
                    </p>
                    <p className="text-sm font-semibold text-foreground">
                ...
                <div>
                  <p className="text-[10px] font-semibold text-muted-foreground uppercase tracking-wide mb-2">
                    {t("onboarding.confirmDialog.featuresLabel")}
                  </p>
          ...
          <AlertDialogFooter>
            <AlertDialogCancel className="rounded-xl" disabled={isSubmitting}>
              {t("onboarding.confirmDialog.goBack")}
            </AlertDialogCancel>
            <AlertDialogAction
            ...
            >
              {isSubmitting
                ? t("onboarding.confirmDialog.saving")
                : t("onboarding.confirmDialog.confirmButton")}
            </AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>
      </AlertDialog>
