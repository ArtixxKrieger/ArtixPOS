...
export default function Login() {
  ...
  // Simple error view — no GSAP, no pricing, no scroll animations.
  // Renders before any complex hooks to avoid white-screen crashes.
  if (error) {
      ...
      >
        ...
        >
          ...
          <div style={{ fontSize: 14, color: "#a1a1aa", marginBottom: 20, lineHeight: 1.5 }}>
            {messages[error] || "An unexpected error occurred during sign-in."}
          </div>
          <a
            href="/login"
            style={{
