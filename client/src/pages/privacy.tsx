      ...
      >
        ...
        <main style={{ flex: 1, minWidth: 0 }}>
          ...
          <div style={{ marginBottom: 52, paddingBottom: 36, borderBottom: `1px solid ${BORDER}` }}>
            ...
            >
              This Privacy Policy describes how ArtixPOS collects, uses, stores, and shares
              information about you when you use our platform. We are committed to protecting your
          ...
          >
            ...
            <p
              style={{ fontSize: 14, lineHeight: 1.75, color: "rgba(255,255,255,0.60)", margin: 0 }}
            >
              We collect what's needed to run your account and power the app. We never sell your
              data. We never use it for advertising. Your business data belongs to you. You can
              export or delete everything at any time. If you have questions, email us at{" "}
              <a href="mailto:privacy@artixpos.com" style={{ color: BLUE, textDecoration: "none" }}>
                privacy@artixpos.com
              </a>
              .
            </p>
          </div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 52 }}>
            ...
            <section>
              ...
              <Body>
                ArtixPOS ("we," "us," "our") operates the ArtixPOS web application and associated
                mobile applications (collectively, the "Service"). This Privacy Policy explains how
                we collect, use, disclose, and safeguard your information when you use our Service.
              </Body>
              <Body>
                By creating an account or using the Service, you consent to the collection and use
                of your information in accordance with this Policy. If you do not agree with the
                terms of this Policy, please do not use the Service.
              </Body>
              <Body>
                This Policy applies to all users of the Service, including business owners,
                administrators, staff members, and any other individuals who interact with the
                platform. For the avoidance of doubt, this Policy does not apply to the practices of
                third parties that ArtixPOS does not own or control.
              </Body>
            </section>
            ...
            <section>
              ...
              <Body>
                ArtixPOS is a business management and point-of-sale platform. For the purposes of
                data protection law, ArtixPOS is the data controller in respect of any personal
                information you provide to us when creating or managing your account.
              </Body>
              <Body>
                In the context of your business data (e.g., your customers' information, sales
                records, staff data), you are the data controller and ArtixPOS acts as your data
                processor. We process that data only on your instructions and in accordance with
                this Policy and our Terms of Service.
              </Body>
              <Body>
                If you are a staff member or employee whose employer uses ArtixPOS, your employer is
                the primary data controller of your employment-related data within the platform. We
                recommend reviewing your employer's own privacy practices in addition to this
                Policy.
              </Body>
            </section>
            ...
            <section>
              ...
              />
              <Body>
                This business data belongs to you. We store it to power the Service and do not use
                it for any purpose beyond providing and improving the Service.
              </Body>
              ...
              <Body>
                If you contact us via email, support tickets, or in-app feedback forms, we retain
                those communications to help resolve your inquiry and improve our support quality.
              </Body>
              <SubHeader>3.5 OAuth / Social Login Data</SubHeader>
              <Body>
                If you choose to sign in via Google OAuth, we receive your name, email address, and
                profile photo from that provider. We do not receive your password or payment
            ...
            <section>
              ...
              />
              <Body>
                <strong style={{ color: "rgba(255,255,255,0.75)" }}>We do not:</strong> sell your
                personal data, use your business data for advertising, share your data with
                advertising networks, or use your data to build profiles for resale to data brokers.
              </Body>
            </section>
            ...
            <section>
              ...
              <Body>
                Where applicable under data protection laws (including the Philippines Data Privacy
                Act of 2012 and, where relevant, the EU GDPR), we rely on the following legal bases
            ...
            <section>
              ...
              <Body>
                We engage trusted third-party service providers to assist in operating and improving
                the Service. These providers access your data only to perform services on our behalf
                and are contractually prohibited from using your data for any other purpose.
              </Body>
              <SubHeader>6.2 Legal Requirements</SubHeader>
              <Body>
                We may disclose your information if required to do so by law, or in good-faith
                belief that such disclosure is necessary to: (a) comply with a legal obligation or
                court order; (b) protect and defend the rights or property of ArtixPOS; (c) prevent
                or investigate possible wrongdoing in connection with the Service; or (d) protect
                the personal safety of users or the public.
              </Body>
              <SubHeader>6.3 Business Transfers</SubHeader>
              <Body>
                In the event of a merger, acquisition, asset sale, financing, or reorganization of
                ArtixPOS, your information may be transferred as part of that transaction. We will
                notify you before your information is subject to a different privacy policy as a
              ...
              <Body>
                ...
                consent to do so, such as when you authorize a third-party integration with your
                ArtixPOS account.
              </Body>
              <SubHeader>6.5 Aggregated / Anonymized Data</SubHeader>
              <Body>
                We may share aggregated, anonymized, non-personally-identifiable information
                publicly or with partners for research, analytics, or product development purposes.
              </Body>
            </section>
            ...
            <section>
              ...
              <Body>
                The Service integrates with the following third-party services, each with their own
                privacy policies:
              </Body>
              <div
                style={{ display: "flex", flexDirection: "column", gap: 12, margin: "0 0 20px" }}
              >
                {[
                  {
                    name: "PayMongo",
                  ...
                  >
                    ...
                    >
                      <span
                        style={{ fontSize: 13.5, fontWeight: 700, color: "rgba(255,255,255,0.85)" }}
                      >
                        {name}
                      </span>
                      {url && (
                    ...
                    <p
                      style={{ fontSize: 12.5, color: "rgba(255,255,255,0.35)", margin: "0 0 6px" }}
                    >
                      {role}
                    </p>
                    <p
            ...
            <section>
              ...
              <Body>
                ArtixPOS stores a small amount of data in your browser to keep you logged in, save
                your preferences (theme, language, sidebar state), and enable offline POS
                functionality. We use secure cookies for authentication and your browser's local
                storage for app state. No data is shared with advertising networks.
              </Body>
            ...
            <section>
              ...
              />
              <Body>
                After the applicable retention period, we securely delete or anonymize your data. If
                you request account deletion before a retention period expires, we will delete your
                data except where retention is required for legal or regulatory compliance.
              </Body>
            </section>
            ...
            <section>
              ...
              <Body>
                ...
                breach that materially affects your personal information, we will: (a) notify
                affected users within 72 hours of confirmed discovery; (b) provide information about
                what was affected and steps taken; and (c) cooperate with relevant authorities as
                required by law.
              </Body>
              <Body>
                To report a security vulnerability, please contact us responsibly at{" "}
                <a
                  href="mailto:security@artixpos.com"
                  style={{ color: BLUE, textDecoration: "none" }}
                >
                  security@artixpos.com
                </a>
                . We have a responsible disclosure process and will acknowledge valid reports within
                48 hours.
              </Body>
            </section>
            ...
            <section>
              ...
              <Body>
                ArtixPOS is based in the Philippines and primarily serves customers in the
                Philippines and Southeast Asia. Your data may be processed in data centers located
                in the Philippines, Singapore, or the United States, depending on our infrastructure
                providers.
              </Body>
              <Body>
                When your data is transferred outside of your country of residence, we ensure that
                appropriate safeguards are in place in accordance with applicable law, including
                standard contractual clauses, adequacy decisions, or other legally recognized
                transfer mechanisms.
              </Body>
              <Body>
                By using the Service, you consent to your information being transferred to and
                processed in countries other than your own. We ensure that any such transfer is made
            ...
            <section>
              ...
              <div
                style={{ display: "flex", flexDirection: "column", gap: 10, margin: "0 0 20px" }}
              >
                {[
                  {
                    right: "Right to Access",
                    desc: "Request a copy of the personal information we hold about you, including what data we have, how we use it, and who we share it with.",
                  },
                  {
                    right: "Right to Rectification",
                    desc: "Request that we correct inaccurate or incomplete personal information about you. You can update most information directly in your account settings.",
                  },
                  {
                    right: "Right to Erasure",
                    desc: "Request deletion of your personal information and all associated business data. You can delete your account from your settings, or email us to initiate deletion.",
                  },
                  {
                    right: "Right to Data Portability",
                    desc: "Request an export of your data in a structured, machine-readable format. Use the export tools in your account settings or contact us.",
                  },
                  {
                    right: "Right to Object",
                    desc: "Object to our processing of your personal information in certain circumstances, including where we rely on legitimate interests.",
                  },
                  {
                    right: "Right to Restriction",
                    desc: "Request that we restrict processing of your personal information under certain conditions.",
                  },
                  {
                    right: "Right to Withdraw Consent",
                    desc: "Where processing is based on your consent, you may withdraw that consent at any time without affecting the lawfulness of prior processing.",
                  },
                ].map(({ right, desc }) => (
                  <div
                    key={right}
              ...
              <Body>
                ...
                <a
                  href="mailto:privacy@artixpos.com"
                  style={{ color: BLUE, textDecoration: "none" }}
                >
                  privacy@artixpos.com
                </a>
              ...
              <Body>
                ...
                with the National Privacy Commission (NPC) of the Philippines or the relevant
            ...
            <section>
              ...
              <Body>
                ...
                child under 13, we will take immediate steps to delete that information from our
                servers. Users between 13 and 17 may use the Service with verifiable parental or
                guardian consent.
              </Body>
            </section>
            ...
            <section>
              ...
              <Body>
                If ArtixPOS is involved in a merger, acquisition, asset sale, financing,
                reorganization, bankruptcy, or any other business combination, your information may
                be transferred to the succeeding entity as part of that transaction. We will notify
                you via email and/or a prominent notice within the Service at least 30 days before
                your information becomes subject to a materially different privacy policy as a
                result of such a transfer.
              </Body>
              <Body>
                In any such event, we will seek to ensure that the acquiring party is bound by terms
                that provide at least the same level of protection for your personal information as
            ...
            <section>
              ...
              <Body>
                ArtixPOS includes AI-powered features such as the business assistant, insights, and
                automated recommendations. Here is how we handle your data in relation to these
                features:
              </Body>
              <BulletList
                items={[
              ...
              />
              <Body>
                We recommend that you do not include sensitive personal information (such as
                customer payment details, full national ID numbers, or similar sensitive data) in AI
                assistant queries.
              </Body>
            </section>
            ...
            <section>
              ...
              />
              <Body>
                For non-material changes (such as clarifications or corrections that do not affect
                how we use your data), we may update the Policy without separate notice. We
            ...
            <section>
              ...
              <Body>
                ...
                <strong style={{ color: "rgba(255,255,255,0.70)" }}>30 days</strong> of receipt. For
                data deletion and portability requests, we may require identity verification before
                processing.
              </Body>
              <Body>
                If you are a resident of the Philippines and believe your data protection rights
                have been violated, you may file a complaint with the{" "}
  ...
  return (
    ...
    >
      {entries.map(({ label, value }) => (
        ...
        >
          <span style={{ fontSize: 12.5, color: "rgba(255,255,255,0.35)", minWidth: 200 }}>
            {label}
          </span>
          <a
            href={`mailto:${value}`}
