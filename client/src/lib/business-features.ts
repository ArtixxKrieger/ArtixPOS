...
export function getBusinessFeatures(
  ...
  if (!businessType || businessType === "other") {
    ...
    return {
      hiddenUrls: hidden,
      essentialUrls: getEssentialBusinessUrls(businessType, businessSubType),
      showBarcode,
      primaryNavUrls,
      labels,
      sidebarOrder,
    ...
    switch (businessSubType) {
      ...
      case "bar":
        ...
        terminology = {
          ...
          staff: "Bartender",
          product: "Drink",
          productPlural: "Drinks",
          categoryLabel: "Drink Type",
          supplierLabel: "Beverage Supplier",
          posAction: "Close Tab",
          addToCartLabel: "Add to Tab",
          cartLabel: "Tab",
          transactionLabel: "Bill",
          transactionPlural: "Bills",
          orderLabel: "bill",
          topItemsLabel: "Top Sellers",
          itemUnit: "drink",
      ...
      case "bakery":
        ...
        terminology = {
          ...
          staff: "Baker",
          product: "Baked Good",
          productPlural: "Baked Goods",
          categoryLabel: "Product Type",
          posAction: "Complete Order",
          addToCartLabel: "Add to Order",
          cartLabel: "Order",
    ...
    switch (businessSubType) {
      ...
      case "drugstore":
        ...
        terminology = {
          ...
          supplierLabel: "Drug Supplier",
          posAction: "Dispense",
          addToCartLabel: "Add to Prescription",
          cartLabel: "Prescription",
          transactionLabel: "Dispensation",
          transactionPlural: "Dispensations",
      ...
      case "clothing":
        ...
        terminology = {
          ...
          supplierLabel: "Brand / Supplier",
          posAction: "Complete Purchase",
          addToCartLabel: "Add to Cart",
          cartLabel: "Cart",
          transactionLabel: "Sale",
          transactionPlural: "Sales",
      ...
      case "bookstore":
        ...
        terminology = {
          ...
          product: "Book",
          productPlural: "Books",
          categoryLabel: "Genre / Section",
          supplierLabel: "Publisher",
          posAction: "Complete Purchase",
          addToCartLabel: "Add to Cart",
          cartLabel: "Cart",
          transactionLabel: "Sale",
    ...
    switch (businessSubType) {
      ...
      case "massage":
        ...
        terminology = {
          ...
          product: "Retail Product",
          productPlural: "Retail Products",
          categoryLabel: "Massage Type",
          supplierLabel: "Supplier",
          posAction: "Check Out",
          addToCartLabel: "Add Treatment",
          cartLabel: "Bill",
          transactionLabel: "Visit",
          transactionPlural: "Visits",
          orderLabel: "booking",
          topItemsLabel: "Top Treatments",
          itemUnit: "booking",
          bestSellerLabel: "Most Booked",
        };
        quickSuggestions = [
      ...
      case "gym":
        ...
        terminology = {
          ...
          product: "Product",
          productPlural: "Merchandise",
          categoryLabel: "Category",
          supplierLabel: "Supplier",
          posAction: "Process Payment",
          addToCartLabel: "Add Item",
          cartLabel: "Bill",
          transactionLabel: "Payment",
          transactionPlural: "Payments",
          orderLabel: "session",
          topItemsLabel: "Top Sessions",
          itemUnit: "session",
      ...
      case "clinic":
        ...
        terminology = {
          page: "Patients",
          entry: "Patient",
          entryPlural: "Patients",
          service: "Procedure",
          customer: "Patient",
          staff: "Doctor",
          room: "Examination Room",
          bookButton: "Schedule",
          emptyState: "No patients today",
          product: "Medical Supply",
          productPlural: "Medical Supplies",
          categoryLabel: "Procedure Type",
          supplierLabel: "Medical Supplier",
          posAction: "Bill Patient",
          addToCartLabel: "Add Charge",
          cartLabel: "Bill",
          transactionLabel: "Consultation",
          transactionPlural: "Consultations",
          orderLabel: "consultation",
          topItemsLabel: "Top Procedures",
          itemUnit: "patient",
      ...
      case "dental":
        ...
        terminology = {
          ...
          bookButton: "Schedule",
          emptyState: "No patients today",
          product: "Dental Supply",
          productPlural: "Dental Supplies",
          categoryLabel: "Procedure Type",
          supplierLabel: "Dental Supplier",
          posAction: "Bill Patient",
          addToCartLabel: "Add Charge",
          cartLabel: "Bill",
          transactionLabel: "Consultation",
      ...
      case "pet_grooming":
        primaryNavUrls = ["/appointments", "/customers"];
        labels = {
          "/appointments": "Grooming Bookings",
          "/customers": "Pet Owners",
          "/staff": "Groomers",
          "/rooms": "Grooming Stations",
          "/pos": "Check Out",
        ...
        terminology = {
          ...
          customer: "Pet Owner",
          staff: "Groomer",
          room: "Grooming Station",
          bookButton: "Book",
          emptyState: "No grooming bookings today",
          product: "Grooming Product",
          productPlural: "Grooming Products",
          categoryLabel: "Service Type",
          supplierLabel: "Supplier",
          posAction: "Check Out",
          addToCartLabel: "Add Service",
      ...
      case "car_wash":
        ...
        terminology = {
          ...
          product: "Wash Service",
          productPlural: "Wash Services",
          categoryLabel: "Wash Type",
          supplierLabel: "Supplier",
          posAction: "Process Job",
          addToCartLabel: "Add Service",
          cartLabel: "Job Order",
          transactionLabel: "Job",
          transactionPlural: "Jobs",
          orderLabel: "job",
          topItemsLabel: "Top Wash Types",
          itemUnit: "job",
          bestSellerLabel: "Most Popular",
        };
        quickSuggestions = [
      ...
      case "repair":
        primaryNavUrls = ["/appointments", "/customers"];
        labels = {
          "/appointments": "Repair Jobs",
          "/customers": "Clients",
          "/pos": "Open Job",
          "/products": "Parts & Services",
          "/transactions": "Repair Jobs",
        ...
        terminology = {
          ...
          room: "Bay",
          bookButton: "Add Job",
          emptyState: "No repair jobs",
          product: "Part / Service",
          productPlural: "Parts & Services",
          categoryLabel: "Repair Type",
          supplierLabel: "Parts Supplier",
          posAction: "Close Job",
          addToCartLabel: "Add Part / Service",
          cartLabel: "Job Order",
          transactionLabel: "Job",
          transactionPlural: "Jobs",
          orderLabel: "job",
          topItemsLabel: "Top Repair Types",
          itemUnit: "job",
      ...
      case "laundry":
        ...
        terminology = {
          ...
          staff: "Staff",
          room: "Station",
          bookButton: "New Order",
          emptyState: "No laundry orders",
          product: "Service",
          productPlural: "Services",
          categoryLabel: "Service Type",
          supplierLabel: "Supplier",
          posAction: "Process Order",
          addToCartLabel: "Add Service",
          cartLabel: "Order",
          transactionLabel: "Order",
          transactionPlural: "Orders",
      ...
      case "photography":
        ...
        terminology = {
          ...
          staff: "Photographer",
          room: "Studio",
          bookButton: "Book Shoot",
          emptyState: "No shoots booked",
          product: "Package",
          productPlural: "Packages & Add-ons",
          categoryLabel: "Shoot Category",
          supplierLabel: "Vendor",
          posAction: "Complete Booking",
          addToCartLabel: "Add to Package",
          cartLabel: "Invoice",
          transactionLabel: "Booking",
          transactionPlural: "Bookings",
          orderLabel: "booking",
          topItemsLabel: "Top Shoot Types",
          itemUnit: "session",
          bestSellerLabel: "Most Booked",
        };
        quickSuggestions = [
      ...
      case "tutoring":
        ...
        terminology = {
          ...
          bookButton: "Schedule",
          emptyState: "No sessions scheduled",
          product: "Study Package",
          productPlural: "Study Packages",
          categoryLabel: "Subject Area",
          supplierLabel: "Supplier",
          posAction: "Process Payment",
          addToCartLabel: "Add Session",
          cartLabel: "Invoice",
          transactionLabel: "Session",
          transactionPlural: "Sessions",
          orderLabel: "session",
          topItemsLabel: "Top Subjects",
          itemUnit: "session",
          bestSellerLabel: "Most Scheduled",
        };
        quickSuggestions = [
      ...
      case "cleaning":
        ...
        labels = {
          "/appointments": "Bookings",
          "/staff": "Cleaning Teams",
          "/customers": "Clients",
          "/pos": "New Job",
          "/products": "Cleaning Services",
          "/transactions": "Jobs",
        };
        hidden.add("/memberships");
        hidden.add("/rooms");
        ...
        terminology = {
          ...
          room: "Area",
          bookButton: "Book",
          emptyState: "No cleaning jobs",
          product: "Service",
          productPlural: "Cleaning Services",
          categoryLabel: "Service Type",
          supplierLabel: "Supplier",
          posAction: "Complete Job",
          addToCartLabel: "Add Service",
